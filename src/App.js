...
function App() {
  ...
  useEffect(() => {
    fetch('https://nba-bets-data.s3.us-east-1.amazonaws.com/top_5_bets_with_teams.csv')
  ...
  return (
    <div className="bg-[#fdf7f0] font-sans overflow-x-hidden m-0 p-0">
      {/* Blue Hero Header */}
      <div className="relative w-full bg-blue-700 text-white text-center h-[700px] flex flex-col justify-center">
        {/* 🦁 Lion Logo */}
        <div className= "header">
        <img
          src="/assets/lion.png"
          alt="Top 5 Bets Logo"
          className="mx-auto h-40 w-40 mb-1"
        />

        <h1 className="text-4xl text-white font-extrabold">NBA Bet Dashboard</h1>
      ...
      {/* Bet Cards Section */}
      <div className="relative z-20 bg-white pb-16 px-4 sm:px-6 lg:px-8 -mt-28">
